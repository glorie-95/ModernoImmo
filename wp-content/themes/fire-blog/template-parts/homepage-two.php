...
<section class="site-section home-next home_two_col">
    <div class="container">
        <div class="row">
            <div class="content col-lg-12">
                    ...
                    if( is_sticky() ){ ?>   
                        <div class="blog-box clearfix">
                            <div class="blog-media">
                                <a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( 'fire_blog_homepage_sticky_posts' ) ?></a>
                            </div>
                            <!-- end blog-media -->
                ...
                fire_blog_wp_custom_pagination(array('prev_text' => esc_html( '>>', 'fire-blog' ), 'next_text' => esc_html( '<<', 'fire-blog' )));
                ?>
            </div><!-- end col -->
        </div><!-- end row -->
    </div><!-- end container -->
