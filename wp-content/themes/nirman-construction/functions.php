...
//footer Link
define('NIRMAN_CONSTUCTION_CREDIT','https://www.luzuk.com/','nirman-construction');

if ( ! function_exists( 'nirman_construction_credit' ) ) {
	function nirman_construction_credit(){
		echo "<a href=".esc_url(NIRMAN_CONSTUCTION_CREDIT)." target='_blank'>".esc_html__('Luzuk','nirman-construction')."</a>";
	}
}
