          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
              ...
              <div class="carousel-caption">
                <div class="inner_carousel">
                  <h2><?php the_title();?></h2>  
                  <p><?php $excerpt = get_the_excerpt(); echo esc_html( mega_construction_string_limit_words( $excerpt,25 ) ); ?></p>
                </div>
              </div>
          </div>
          <?php $i++; $m++; endwhile; 
  ...
  <div id="header">
    <div class="menu-sec">
      <div class="container">
        ...
        <div class="row">
          <div class="menubox col-lg-10 col-md-10">
            <div class="nav">
              <?php wp_nav_menu( array('theme_location'  => 'primary') ); ?>
            </div>
          </div>
          <div class="search-box col-lg-2 col-md-2">
