...
define('MEGA_CONSTRUCTION_THEME_DOC','http://www.themesglance.com/demo/docs/mega-construction-pro/','mega-construction');
define('MEGA_CONSTRUCTION_LIVE_DEMO','https://themesglance.com/mega-construction-pro/','mega-construction');
define('MEGA_CONSTRUCTION_FREE_THEME_DOC','http://themesglance.com/demo/docs/free-mega-construction/','mega-construction');
define('MEGA_CONSTRUCTION_SUPPORT','https://wordpress.org/support/theme/mega-construction/','mega-construction');
define('MEGA_CONSTRUCTION_REVIEW','https://wordpress.org/support/theme/mega-construction/reviews','mega-construction');

define('MEGA_CONSTRUCTION_SITE_URL','https://www.themesglance.com/themes/free-construction-wordpress-theme/','mega-construction');
