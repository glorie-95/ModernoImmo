		...
		<div id="comments" class="comments-area">
			...
			<?php if ( have_comments() ) : ?>
				...
				<h4 class="comments-title">
					<?php
						printf( _nx( '%3$s comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'seopress' ),
							number_format_i18n( get_comments_number() ), '<span>' . get_the_title() . '</span>', __( 'One', 'seopress' ) );
					?>
				</h4>
