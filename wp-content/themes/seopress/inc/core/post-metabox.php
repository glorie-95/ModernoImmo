...
if( is_admin() )
{
    add_action( 'load-post.php', 'seopress_post_meta_box_first_func' );
    add_action( 'load-post-new.php', 'seopress_post_meta_box_first_func' );
}

/**
 * Calls the class on the post edit screen.
 */
function seopress_post_meta_box_first_func()
{
    new SEOPress_Post_Meta_Box_Main_Class();
}
 
/**
 * The Class.
 */
class SEOPress_Post_Meta_Box_Main_Class
{
    ...
    public function add_meta_box( $post_type )
    {
        ...
        {
            add_meta_box(
                'seopress_post_meta_box_cntnr',
                __( 'SEOPress Options for this Post', 'seopress' ),
    ...
    public function render_meta_box_content( $post )
    {
        ...
        wp_nonce_field( 'seopress_post_meta_bx_key', 'seopress_post_meta_bx_key_nonce' );
    ...
    public function save( $post_id )
    {
        ...
        if( ! isset( $_POST['seopress_post_meta_bx_key_nonce'] ) )
        {
            return $post_id;
        }
 
        $nonce = wp_unslash( $_POST['seopress_post_meta_bx_key_nonce'] );
 
        // Verify that the nonce is valid.
        if( ! wp_verify_nonce( $nonce, 'seopress_post_meta_bx_key' ) )
        {
            return $post_id;
        }
