   ...
   <div class="footer-column-three">
    ...
    <?php endif; 
             ...
             { echo esc_attr($my_footer_copyright); }
              ...
              { esc_attr_e('Powered by realestatetheme.eu','real-estate-right-now'); }
 ?>         
			</div><!-- .site-info -->
</div><!-- .site -->
</div><!-- wrapper -->
...
<?php esc_attr_e( 'Back to Top', 'real-estate-right-now' ); ?><?php esc_attr_e( 'Back to Top', 'real-estate-right-now' ); ?></a>
</div> 
<?php } ?>
</body>
<?php wp_footer(); ?>
