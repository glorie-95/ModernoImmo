<?php
if (!class_exists('Construction_Map_Recent_Post_Widget')) {
    class Construction_Map_Recent_Post_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Latest Blogs', 'construction-map'),
        ...
        {
            parent::__construct(
                'construction-map-recent-post-widget',
                esc_html__('CM: Latest Blog Widget', 'construction-map'),
                array('description' => esc_html__('Construction Latest Blog Section', 'construction-map'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('cat_id')); ?>">
                    <?php esc_html_e('Select Category', 'construction-map'); ?>
                </label><br/>
                <?php
                $Construction_con_dropown_cat = array(
                    'show_option_none' => esc_html__('From Recent Posts', 'construction-map'),
                    'orderby' => 'name',
                    'order' => 'asc',
                    'show_count' => 1,
                    'hide_empty' => 1,
                                        ...
                                        <div class="media-body">
                                            <div class="single-post-text">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="<?php the_permalink();?>"><i class="fa fa-folder"></i><?php construction_map_entry_footer(); ?></a></li>

                                                </ul>
                                                <p><?php echo esc_html(wp_trim_words(get_the_content(), 20)); ?> </p>
                                                <a href="<?php the_permalink();?>" class="btn price_btn"><?php esc_html_e( 'Read More', 'construction-map' ); ?></a>
                                            </div>
                                        </div>
                                    </div>
...
add_action('widgets_init', 'construction_map_recent_post_widget');
function construction_map_recent_post_widget()
{
    register_widget('construction_map_Recent_Post_Widget');
