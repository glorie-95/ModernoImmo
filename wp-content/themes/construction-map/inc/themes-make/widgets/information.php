<?php
if (!class_exists('Construction_Map_Top_Info_Widget')) {
    class Construction_Map_Top_Info_Widget extends WP_Widget
    {
        ...
        {
            parent::__construct(
                'construction_map-top-info-widget',
                esc_html__('CM: Top Info Widget', 'construction-map'),
                array('address' => esc_html__('Education top-info Section', 'construction-map'))
            );
        }
        ...
        public function form($instance)
        {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title1')); ?>">
                    <?php echo esc_html__('title1 ', 'construction-map'); ?>
                </label><br/>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('address')); ?>">
                    <?php echo esc_html__('Adress', 'construction-map'); ?>
                </label><br/>
                <input type="text"
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('location_icon')); ?>"><?php echo esc_html__('Location Icon ', 'construction-map'); ?>
                </label><br/>
                <small>
                    <?php
                    esc_html_e('Font Awesome Icon Used in Widgets', 'construction-map');
                    printf(__('%1$sRefer here%2$s for icon class. For example: %3$sfa-desktop%4$s', 'construction-map'), '<br /><a href="' . esc_url('http://fontawesome.io/cheatsheet/') . '" target="_blank">', '</a>', "<code>", "</code>");
                    ?>
                </small>
                <strong>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title2')); ?>">
                    <?php echo esc_html__('title2', 'construction-map'); ?>
                </label><br/>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('phone')); ?>">
                    <?php echo esc_html__('phone', 'construction-map'); ?>
                </label><br/>
                <input type="text"
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('contact_icon')); ?>"><?php echo esc_html__('contact icon ', 'construction-map'); ?>
                </label><br/>
                <small>
                    <?php
                    esc_html_e('Font Awesome Icon Used in Widgets', 'construction-map');
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title3')); ?>">
                    <?php echo esc_html__('title3', 'construction-map'); ?>
                </label><br/>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('email')); ?>">
                    <?php echo esc_html__('Email', 'construction-map'); ?>
                </label><br/>
                <input type="text"
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('email_icon')); ?>"><?php echo esc_html__('Email Icon ', 'construction-map'); ?>
                </label><br/>
                <small>
                    <?php
                    esc_html_e('Font Awesome Icon Used in Widgets', 'construction-map');
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('title4')); ?>">
                    <?php echo esc_html__('title4', 'construction-map'); ?>
                </label><br/>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('time')); ?>">
                    <?php echo esc_html__('Time', 'construction-map'); ?>
                </label><br/>
                <input type="text"
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('hour_icon')); ?>"><?php echo esc_html__('Hour Icon ', 'construction-map'); ?>
                </label><br/>
                <small>
                    <?php
                    esc_html_e('Font Awesome Icon Used in Widgets', 'construction-map');
...
<section class="info">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-3 info" data-wow-duration="2s">
                            <div class="info-icon">
...
add_action('widgets_init', 'construction_map_top_info_widget');
function construction_map_top_info_widget()
{
    register_widget('construction_map_top_info_widget');
