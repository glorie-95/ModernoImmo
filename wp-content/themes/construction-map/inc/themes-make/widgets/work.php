<?php
if (!class_exists('Construction_Map_Work_Widget')) {
    class Construction_Map_Work_Widget extends WP_Widget
    {
        ...
        private function defaults()
        {
            ...
            $defaults = array(
                'cat_id' => 0,
                'title' => esc_html__('Our Work', 'construction-map'),
        ...
        {
            parent::__construct(
                'construction-map-work-widget',
                esc_html__('CM: Our Work Widget', 'construction-map'),
                array('description' => esc_html__('Construction Recent Post Section', 'construction-map'))
            );
        }
...
add_action('widgets_init', 'construction_map_work_widget');
function  construction_map_work_widget()
{
    register_widget('Construction_Map_Work_Widget');
