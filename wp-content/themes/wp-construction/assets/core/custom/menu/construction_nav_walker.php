<?php
/** nav-menu-walker.php */
class wp_construction_nav_walker extends Walker_Nav_Menu {	
...
function wp_construction_nav_menu_css_class( $classes ) {
...
add_filter( 'nav_menu_css_class', 'wp_construction_nav_menu_css_class' );
?>