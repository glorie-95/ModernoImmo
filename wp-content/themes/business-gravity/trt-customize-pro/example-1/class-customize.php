 ...
 * @access public
 */
final class Businessgravity_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Businessgravity_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Businessgravity_Customize_Section_Pro(
				$manager,
				'example_1',
				array(
					'title'    => esc_html__( 'Business Gravity Pro', 'business-gravity' ),
					'priority' => 1,
					'pro_text' => esc_html__( 'Buy Pro', 'business-gravity' ),
					'pro_url'  => 'https://keonthemes.com/downloads/business-gravity-pro'
				)
			)
		);
	}
...
Businessgravity_Customize::get_instance();
