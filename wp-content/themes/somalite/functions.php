...
function somalite_google_fonts_url() {
  $body_font    = get_theme_mod('sm_body_font_name', 'Lato:400,300,700,900');
  $heading_font   = get_theme_mod('sm_heading_font_name', 'Lato:400,300,700,900');
 ...
 * Upgrade Pro
 */
require_once( trailingslashit( get_template_directory() ) . 'soma-pro/class-customize.php' );
