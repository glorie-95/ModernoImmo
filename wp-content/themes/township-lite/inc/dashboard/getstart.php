...
function township_lite_admin_theme_style() {
   wp_enqueue_style( 'township-lite-font', township_lite_admin_font_url(), array() );
...
// Theme Font URL
function township_lite_admin_font_url() {
	$font_url = '';
	$font_family = array();
...
<div class="wrapper-info">  
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks home" onclick="openCity(event, 'tc_index')"><?php esc_html_e( 'Free Theme Information', 'township-lite' ); ?></button>
		  	<button class="tablinks" onclick="openCity(event, 'tc_pro')"><?php esc_html_e( 'Click to Premium Theme', 'township-lite' ); ?></button>		  	
		</div>
