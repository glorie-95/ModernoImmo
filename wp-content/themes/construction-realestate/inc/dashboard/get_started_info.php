...
function construction_realestate_notice(){
    ...
    <div class="notice notice-success is-dismissible getting_started">
		<div class="notice-content">
			...
			<p><?php esc_html_e( 'Take benefit of a variety of features, functionalities, elements, and an exclusive set of customization options to build your own professional real estate business website.', 'construction-realestate' ) ?></p>
			<p><?php esc_html_e( "Please Click on the link below to know the theme setup information", 'construction-realestate' ) ?></p>
			<p><a href="<?php echo esc_url( admin_url( 'themes.php?page=construction-realestate-guide-page' ) ); ?>" class="button button-primary"><?php esc_html_e( 'Getting Started With Construction Realestate', 'construction-realestate' ); ?></a></p>
		</div>
	</div>
	<?php }
}
