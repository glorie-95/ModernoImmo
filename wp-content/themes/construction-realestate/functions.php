...
function construction_realestate_widgets_init() {
	...
	for ($i=1; $i<=$widget_areas; $i++) {
		register_sidebar( array(
			'name'          => __( 'Footer Widget ', 'construction-realestate' ) . $i,
			'id'            => 'footer-' . $i,
			'description'   => '',
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget'  => '</aside>',
...
define('CONSTRUCTION_REALESTATE_PRO_DOC','https://www.buywptemplates.com/demo/docs/construction-realestate-pro/','construction-realestate');
...
if ( ! function_exists( 'construction_realestate_credit' ) ) {
	function construction_realestate_credit(){
		echo "<a href=".esc_url(CONSTRUCTION_REALESTATE_CREDIT)." target='_blank'>Buywptemplate</a>";
	}
}
