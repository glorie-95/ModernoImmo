		...
		$manager->add_section(
			new Hoot_Premium_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => esc_url( admin_url('themes.php?page=metrolo-welcome') ),
					'demo'     => 'https://demo.wphoot.com/metrolo/',
					'docs'     => 'https://wphoot.com/support/',
					'rating'   => 'https://wordpress.org/support/theme/metrolo/reviews/?filter=5#new-post',
				)
			)
		);
	}
