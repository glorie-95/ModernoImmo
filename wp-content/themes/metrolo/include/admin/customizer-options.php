...
function hoot_theme_customizer_options() {
	...
	$lcontent .= '<a class="hoot-cust-link" href="' .
				 ...
				 '</span></a>';
	$lcontent .= '<a class="hoot-cust-link" href="' .
				 'https://wordpress.org/support/theme/metrolo/reviews/?filter=5#new-post' .
				 '" target="_blank"><span class="hoot-cust-link-head">' .
	...
	$settings['logo_image_width'] = array(
		...
		'section'         => $section,
		'type'            => 'text',
		'priority'        => '156', // Keep it with logo image ( 'custom_logo' )->priority logo
		'default'         => 200,
...
function hoot_customizer_modify_default_options( $wp_customize ) {
	...
	$wp_customize->get_control( 'custom_logo' )->priority = 155;
