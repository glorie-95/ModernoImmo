...
if ( ! class_exists( 'Dream_House_Construction_Demo' ) ) {
	 ...
	 * @since 1.0.0
	 */
	class Dream_House_Construction_Demo {

		/**
		 * Singleton instance of Fire_Blog_Demo.
		 *
		 * @var Fire_Blog_Demo $instance Fire_Blog_Demo instance.
		 */
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Dream_House_Construction_Demo ) ) {
				self::$instance = new Dream_House_Construction_Demo();
