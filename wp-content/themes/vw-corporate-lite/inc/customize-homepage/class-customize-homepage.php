 ...
 *
 * @package VW_Corporate_Lite
 */

if ( ! class_exists( 'VW_Corporate_Lite_Content_Creation' ) ) :

	/**
	 * VW_Corporate_Lite_Content_Creation class.
	 */
	class VW_Corporate_Lite_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_Corporate_Lite_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Corporate_Lite_Content_Creation' );
