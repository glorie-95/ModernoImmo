...
class VW_Corporate_Lite_Social_Widget extends WP_Widget {
	function __construct() {
		...
		// Base ID of your widget
			...
			__('Social Icon', 'vw-corporate-lite'),
			// Widget description
	...
	public function form( $instance ) {
		...
		?>	
			...
			<p>
			<label for="<?php echo esc_attr($this->get_field_id('google')); ?>"><?php esc_html_e('Google+:','vw-corporate-lite'); ?></label>
...
} // Class VW_Corporate_Lite_Social_Widget ends here
