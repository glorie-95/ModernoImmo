				...
				<div class="info-link">
					...
					<div class="first-row">
						...
						<div class="row-box">
							...
							<div class="row-box2">
								<span class="dashicons dashicons-admin-links"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[panel]=widgets') ); ?>" target="_blank"><?php esc_html_e('Social Icons','vw-corporate-lite'); ?></a>
							</div>
						</div>
						<div class="row-box">
							<div class="row-box1">
