...
?>
    ...
    <div class="copyright-wrapper">
        <div class="container">
            <div class="copyright">
                <p><?php echo esc_html(get_theme_mod('vw_corporate_lite_footer_copy',__('Copyright 2017-','vw-corporate-lite'))); ?> <?php vw_corporate_lite_credit(); ?></p>
                <?php $theme_lay = get_theme_mod( 'vw_corporate_lite_scroll_top_alignment','Right');
                    if($theme_lay == 'Left'){ ?>
