			...
			<div class="col-md-6">
				<p class="fr-spsl iconouter">
					...
					if( get_theme_mod( 'business_press_display_sicons_top_bar', '1' ) == 1 )
					{
						...
						{
						?>
							<a title="<?php esc_attr_e( 'Ok.ru', 'business-press' ); ?>" <?php echo $s_link_tab; ?> href="<?php echo esc_url( get_theme_mod( 'social_profile_link_okru' ) ); ?>"><span class="fa fa-odnoklassniki bgtoph-icon-clr"></span></a>
						<?php
						}
						?>
