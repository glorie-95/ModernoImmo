...
define('TAMEER_CONSTRUCTION_LIVE_DEMO','https://www.themeseye.com/demo/tameer-construction-pro/','tameer-construction');
define('TAMEER_CONSTRUCTION_BUY_PRO','https://www.themeseye.com/wordpress/construction-wordpress-theme/','tameer-construction');
define('TAMEER_CONSTRUCTION_PRO_DOC','https://www.themeseye.com/theme-demo/docs/tameer-construction-pro/','tameer-construction');
define('TAMEER_CONSTRUCTION_FREE_DOC','https://www.themeseye.com/theme-demo/docs/free-tameer-construction/','tameer-construction');
define('TAMEER_CONSTRUCTION_PRO_SUPPORT','https://www.themeseye.com/forums/forum/themeseye-support/','tameer-construction');
define('TAMEER_CONSTRUCTION_FREE_SUPPORT','https://wordpress.org/support/theme/tameer-construction/','tameer-construction');

//footer Link
define('TAMEER_CONSTRUCTION_CREDIT','https://www.themeseye.com/wordpress/free-construction-wordpress-theme/','tameer-construction');

if ( ! function_exists( 'tameer_construction_credit' ) ) {
	function tameer_construction_credit(){
		echo "<a href=".esc_url(TAMEER_CONSTRUCTION_CREDIT)." target='_blank'>".esc_html__('Construction WordPress Theme','tameer-construction')."</a>";
	}
}
